...
# Thanks To Tasneem Afnan Tabassum ❤️
# Thanks To All Member RATU EROR
...
def banner():
    print("""   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force HBD  │  Script By Afifa Akter  │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/Fahim-XD ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
def menu():
    ...
    print((k+"["+p+"•"+k+"]"+p+" Status  : "+k+"Happy Birthday Fahim"+p))
